...
public class ItemController {
    ...
    public Result save(@RequestBody Item item) {
        if (item.getId() == null) {
            //item.setTime(DateUtil.now());
            //item.setUser(TokenUtils.getCurrentUser().getUsername());
        }
    ...
    public Result findPackage(@PathVariable Integer packageId) {
        return Result.success(itemService.list( new QueryWrapper<Item>().eq("package_id", packageId)));
    }
...
//        }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Item信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Item> list = reader.readAll(Item.class);
