...
public class CodeGenerator {
    private static final String DATASOURCE = "medical-mini";
    private static final String basePath = "D:\\毕设\\作品\\2022.5\\体检预约小程序\\springboot\\";

    private static final String tableName = "reserve";
    private static final String modelName = "体检预约管理";
